...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            ...
            .translationalPIDFCoefficients(new PIDFCoefficients(0.12, 0, 0.02, 0.18))
            .headingPIDFCoefficients(new PIDFCoefficients(1.5, 0, 0.098, 0))
            ...
            .secondaryHeadingPIDFCoefficients(new PIDFCoefficients(5, 0, 0.09, 0.01))
    ...
    public static PathConstraints pathConstraints = new PathConstraints(0.9, 100, 1.2, 1.5);
